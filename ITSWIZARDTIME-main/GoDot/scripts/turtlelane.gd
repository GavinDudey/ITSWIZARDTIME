...
@onready var turtle_section_scene = preload("res://scenes/turtlesection.tscn")

@export var distance_between_sections = 60
@export var speed = 150
@export var turtle_sections_length = [4, 3, 2]
...
func _ready():
	var index = 0
	var starting_position_x = -movement_x_limit + turtle_sections_length[0] * HALF_TURTLE_SIZE * -movement_direction
	
	for section_length in turtle_sections_length:
