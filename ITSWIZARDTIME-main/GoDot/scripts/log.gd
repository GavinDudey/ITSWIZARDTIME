...
@onready var log_start_scene = preload("res://scenes/logstart.tscn")
@onready var log_middle_scene = preload("res://scenes/logmiddle.tscn")
@onready var log_end_scene = preload("res://scenes/logend.tscn")
